...
from authentication import DB_NAME, DB_SERVER, ODBC_DRIVER, get_db_connection
...
def main():
    ...
    sql1 = (
        "SELECT TOP 20 NumAtendimento, AssuntoAtendimento, Situacao, CodCliente, DataAlteracao "
    ...
    sql2 = (
        "SELECT AssuntoAtendimento, COUNT(*) "
        "FROM CNSAtendimento GROUP BY AssuntoAtendimento ORDER BY COUNT(*) DESC"
    )
    cur.execute(sql2)
    try:
