...
QUERIES = [
    ...
    ("Sample 20 rows (NumAtendimento, AssuntoAtendimento, Situacao)", "SELECT TOP 20 NumAtendimento, AssuntoAtendimento, Situacao FROM CNSAtendimento ORDER BY NumAtendimento DESC")
]
