...
Q2 = "SELECT TOP 20 NumAtendimento, AssuntoAtendimento, CONVERT(VARBINARY(MAX), AssuntoAtendimento) as AssuntoBin FROM CNSAtendimento ORDER BY NumAtendimento DESC"
cur.execute(Q2)
...
Q3 = '''SELECT COUNT(1) FROM CNSAtendimento WHERE AssuntoAtendimento LIKE '%Implant%'
